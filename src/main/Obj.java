...
public class Obj {
    ...
    public static Triangle getCollidingTri() { return collidingTri; }
...
//                    System.out.printf("Adding points (%d %d %d) to triangles (%d)\n", point1, point2, point3, fLen);
    ...
    public void projectObject(Camera vCamera, LinkedList<Obj> objects, float fTheta) {
